 ...
 *
 */
package com.example.sun.photoeditdemo.utils.operate;
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (io != null) {
                    if (io.pointOnCorner(event.getX(), event.getY(), OperateConstants.LEFTTOP)) {
                        ...
                        Log.d("test", "pointOnCorner contains");
